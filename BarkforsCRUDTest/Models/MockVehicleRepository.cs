...
public MockVehicleRepository()
{
    _vehicleList = new List<Vehicle>()
    {
        ...
        new Vehicle() {Id = 3, LicencePlateNumber = 3, ModelName = "C3", Brand = Brand.Tesla, TypeOfFuel = TypeOfFuel.Electric, VehicleColor = VehicleColor.White, VehicleEquipment = VehicleEquipment.Sport}
    };
}
